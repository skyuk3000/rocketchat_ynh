...
``` bash
sudo yunohost app install https://github.com/skyuk3000/rocketchat_ynh --debug
or
sudo yunohost app upgrade rocketchat -u https://github.com/skyuk3000/rocketchat_ynh --debug
```
